...
void to_json(nlohmann::json& j, const Object& obj){
    ...
    // Base-Singular semantic envelope; canonical fields above remain the sole
    // authority for geometry/placement/material projections.
...
void from_json(const nlohmann::json& j, Object& obj){
    ...
    // Identity-valued values may defer until the enclosing Zone graph exists.
