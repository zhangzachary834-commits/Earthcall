...
public:
    ...
    // What this Person is called — a Lexeme, not a stored slogan.
    ...
    const std::vector<Zone*>& getJoinedZones() const { return _joinedZones; }
    ...
    //   displayName what this Person is CALLED. A Lexeme. Chosen, editable,
    //               and free to collide with anyone else's. It carries no
...
private:
    ...
    std::string propName() const { return getDisplayName(); }
