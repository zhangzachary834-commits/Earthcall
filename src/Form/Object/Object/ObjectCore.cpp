...
#include "Form/Object/Object/ObjectIdentity.hpp"
#include "Form/Object/Object/ObjectComposition.hpp"
#include "Form/Object/Object/ObjectEvents.hpp"
#include "Form/Object/Contour.hpp"
#include "Form/Object/AngleTools.hpp"
#include "Form/Object/Automation/AutomationEvents.hpp"
...
bool Object::removeElement(Singular* s) {
    if (!s || !_composition._elementFormation.hasMember(s)) return false;
    _composition._elementFormation.removeMember(s);
    return true;
}
...
void Object::claimIdentifierAtLeast(const std::string& id) {
    ObjectIdentity::claimIdentifierAtLeast(id);
}
