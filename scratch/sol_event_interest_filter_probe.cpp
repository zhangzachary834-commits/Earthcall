...
int main() {
    ...
    // Authored state predicates are readable and state-only. Their mere
    // existence is not evidence that anybody hears arbitrary distinguished Moments.
    ...
    // Explicit typed Event listener remains exact evidence.
    ...
    // A hand-written alpha is genuinely opaque and must fail open.
