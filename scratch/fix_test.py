...
jsonA = '{"input": "v", "pieces": [{"where": {"op": 3, "children": [{"op": 1, "var": "v"}, {"op": 0, "scalarForm": {"terms": [{"c": 0.5, "factors": {}}]}}]}, "call": null, "fold": null}, {"guard": {"kind": 3, "children": []}}]}'
jsonB = '{"input": "v", "pieces": [{"where": {"op": 3, "children": [{"op": 0, "scalarForm": {"terms": [{"c": 0.5, "factors": {}}]}}, {"op": 1, "var": "v"}]}, "call": null, "fold": null}, {"guard": {"kind": 3, "children": []}}]}'
