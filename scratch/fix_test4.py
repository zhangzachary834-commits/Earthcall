...
jsonA = '{"input": "v", "pieces": [{"where": {"op": 5, "children": [{"op": 1, "var": "v"}, {"op": 0, "scalarForm": {"terms": [{"c": 0.5, "factors": {}}]}}]}, "node": {"op": 0, "scalarForm": {"terms": [{"c": 1.0, "factors": {}}]}}}, {"guard": {"kind": 3, "children": []}}]}'
jsonB = '{"input": "v", "pieces": [{"where": {"op": 5, "children": [{"op": 0, "scalarForm": {"terms": [{"c": 0.5, "factors": {}}]}}, {"op": 1, "var": "v"}]}, "node": {"op": 0, "scalarForm": {"terms": [{"c": 1.0, "factors": {}}]}}}, {"guard": {"kind": 3, "children": []}}]}'
