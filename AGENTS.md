...
ctest --test-dir build --output-on-failure -j4        # 245 registered (2026-09-25) — WebGPU/GL tests need a desktop GPU/display session; frame_lag_test is machine-load-sensitive (see below)
