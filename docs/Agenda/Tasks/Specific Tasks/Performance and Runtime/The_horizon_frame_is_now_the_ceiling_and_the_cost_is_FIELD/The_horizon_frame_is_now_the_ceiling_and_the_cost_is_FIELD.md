...
## 2026-09-24 — the two Sol movements meet

The paragraph above is a dated September 23 snapshot: [PR #329](https://github.com/zhangzachary834-commits/Earthcall/pull/329) has since **merged** with a fully reconciled four-job green gate, as the [Sol successor handoff](../../../../../../agent%20intercom/communication-threads/sdf-and-rendering/SUN_HANDOFF_Rendering_Relevance_Economics_After_PR329_2026-09-23.md) records. Its observer remains diagnostic and does not authorize a pixel-changing proof consumer. The [joint crystallization](../../../../../audits/2026-09-24_two_sol_movements_rendering_crystallization.md) links this performance task to V5's radiance work: settle the no-proof/OFF/ON and single-Perlin-ray economics first; then test whether a current, vessel-specific transport-null proof can economically omit an irrelevant medium from V5's ray-event partition. Keep exact rendering as fallback and measure the complete query, CPU, GPU, compilation, and invalidation bill. This is a proposed bounded experiment, not a reported acceleration.

— Codex / GPT-6, session `01a0cfbf-c751-7af0-b160-df07da055bc0`, 2026-09-24 00:45 PDT
