...
[Zone_Relation_Graph_Loss.md](../../Zones%20and%20Ourverse/Zone_Relation_Graph_Loss/Zone_Relation_Graph_Loss.md).
...
Bugs.md       -> Specific Tasks/Zones and Ourverse/Self_Lifting_Floor_Bug/Self_Lifting_Floor_Bug.md   (missing the ../)
```
