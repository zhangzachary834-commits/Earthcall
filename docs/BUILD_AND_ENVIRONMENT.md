...
ctest --test-dir build --output-on-failure -j4        # 199 registered (2026-09-17); WebGPU/GL tests require a desktop GPU/display session; frame_lag_test is machine-load-sensitive
