...
BEGIN {
    ...
    require '/Users/zacharyzhang/Documents/GitHub/Earthcall/sight-cpp/local_deps/openssl-3.0.13/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/Users/zacharyzhang/Documents/GitHub/Earthcall/sight-cpp/local_deps/openssl-3.0.13/test/fips-and-base.cnf';
    shift;
